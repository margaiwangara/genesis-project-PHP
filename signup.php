...
$fnameupper = strtoupper($firstname);
$lnameupper = strtoupper($lastname);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if(empty($_POST['age'])){
		...
		if($age > 25){
			$ageerror = "<font color='red'>Age Must Be Less Than 26</font>";
		}
	}
	...
	if(!$error){
		...
		$query = "INSERT INTO registration(firstname,lastname,email,password,day,month,year,gender,age,confirmedemail,confirmcodeemail) VALUES('$fnameupper','$lnameupper','$email','$encpassword','$day','$monthupper','$year','$genderupper','$age','0','$confirmcodeemail')";
		...
		echo "<font color='red'><b>Registration Failed</b></font>" .mysql_error();
			...
			$to = $email;
			$subject = "Hello, " .ucfirst($fnameupper)."<br/><b>Teenageek Email Confirmation</b>";
